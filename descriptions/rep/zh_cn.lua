...
local repCollectibles={
	...
	[30] = {"30", "妈妈的高跟鞋", "↑ {{Range}} 射程+2.5#角色每秒造成24点接触伤害"}, -- Mom's Heels
	[31] = {"31", "妈妈的口红", "↑ {{Range}} 射程+3.75#{{UnknownHeart}} 生成1随机心"}, -- Mom's Lipstick
	[37] = {"37", "炸弹先生", "在角色下方放置1大炸弹, 造成185点伤害"}, -- Mr. Boom
	[40] = {"40", "神风！", "在角色位置造成一次爆炸#造成185点伤害"}, -- Kamikaze!
	[41] = {"41", "妈妈的卫生巾", "{{Fear}} 使房间中所有敌人恐惧4秒#生成1只蓝苍蝇"},
	...
	[92] = {"92", "超级绷带", "↑ {{Heart}} +1心之容器#{{HealingRed}} 治疗1红心#{{SoulHeart}} +2魂心"},
	...
	[147] = {"147", "残损铁镐", "使用时, 角色持拿铁镐#持拿时, 允许角色打碎当前房间中接触的石头, 隐藏房入口, 并对敌人造成伤害#命中时, 降低铁镐的充能#进入新层时, 铁镐完全充能"}, -- Notched Axe
	[148] = {"148", "害虫横行", "受伤时, 生成2-6只蓝苍蝇"}, -- Infestation
	[149] = {"149", "吐根酊", "↑ {{Damage}} 伤害+40#↓ {{Tears}} 射速修正x0.33#↓ {{Range}} 射程修正x0.8#↓ {{Shotspeed}} 弹速修正x0.8#角色的泪弹呈抛物线射出#{{Poison}} 泪弹会爆炸并使击中的敌人中毒"}, -- Ipecac
	...
	[205] = {"205", "锋利插头", "{{Battery}} 使用未完全充能的主动道具时, 重复以半心充能1格直到充满, 不致死#{{Heart}} 优先消耗红心"}, -- Sharp Plug
	[206] = {"206", "断头台", "↑ {{Tears}} 射速修正+0.5#↑ {{Damage}} 伤害+1#角色的头变成环绕物, 不会受到伤害, 每秒造成56点接触伤害"}, -- Guillotine
	[211] = {"211", "蜘蛛宝宝", "受伤时, 生成3-5只蓝蜘蛛"}, -- Spiderbaby
	[214] = {"214", "贫血", "↑ {{Range}} 射程+1.5#{{Timer}} 受伤时, 在房间中留下血迹#血迹每秒造成20点伤害"}, -- Anemic
	...
	[222] =	{"222", "反重力", "↑ {{Tears}} 射速修正+1#按住发射键会使泪弹悬空#松开后, 所有泪弹会向被发射的方向继续前进"}, -- Anti-Gravity
	[223] = {"223", "纵火狂", "{{Bomb}} +5炸弹#免疫爆炸和火焰#{{HealingRed}} 受到爆炸时治疗半红心"}, -- Pyromaniac
	[224] = {"224", "柯吉猫的身体", "↑ {{Tears}} 射速修正+0.5#↓ {{Range}} 射程修正x0.8#泪弹击中后会分裂为4颗#分裂的泪弹造成的伤害减半"}, -- Cricket's Body
	[225] = {"225", "兽性面具", "{{SoulHeart}} 受伤时, 8%概率生成1魂心#{{Luck}} 每点幸运+2%概率#{{HalfHeart}} 敌人死亡时概率掉落1半红心"}, -- Gimpy
	[226] = {"226", "黑莲花", "↑ {{Heart}} +1心之容器#{{HealingRed}} 治疗1红心#{{SoulHeart}} +1魂心#{{BlackHeart}} +1黑心"}, -- Black Lotus
	[228] = {"228", "妈妈的香水", "↑ {{Tears}} 射速修正+0.5#{{Fear}} 15%概率发射恐惧泪弹"}, -- Moms Perfume
	...
	[233] = {"233", "小小星球", "↑ 射程+6.5#灵体泪弹#角色的泪弹环绕在角色周围"}, -- Tiny Planet
	...
	[274] = {"274", "生死之交", "受伤时, 在房间中生成1个中距离环绕物#环绕物每秒造成150点接触伤害"}, -- Best Bud
	...
	[287] = {"287", "秘密之书", "高亮当前房间中的暗门石头与标记石头#{{Timer}} 在本层获得以下三种效果之一:#{{Collectible54}} 藏宝图#{{Collectible21}} 指南针 #{{Collectible246}} 蓝地图#只获得尚未激活的效果#{{Collectible76}} 如果三者都已拥有, 获得X光透视效果"}, -- Book of Secrets
	...
	[307] = {"307", "摩羯座", "↑ {{Heart}} +1心之容器#↑ {{Speed}} 移速+0.1#↑ {{Tears}} 射速修正+0.5#↑ {{Damage}} 伤害+0.5#↑ {{Range}} 射程+0.75#+1{{Coin}}硬币, {{Bomb}}炸弹, {{Key}}钥匙#{{HealingRed}} 治疗1红心"}, -- Capricorn
	[308] = {"308", "宝瓶座", "角色留下水迹#{{Damage}} 水迹每秒造成666%角色伤害, 并继承角色的泪弹效果"}, -- Aquarius
	[309] =	{"309", "双鱼座", "↑ {{Tears}} 射速修正+0.5#↑ {{Tearsize}} 泪弹尺寸+0.12#提高泪弹击退力"}, -- Pisces
	[310] =	{"310", "夏娃的睫毛膏", "↑ {{Damage}} 伤害修正x2#↓ {{Tears}} 射速修正x0.66#↓ {{Shotspeed}} 弹速-0.5"},
	[312] = {"312", "抹大拉的蝴蝶结", "↑ {{Heart}} +1心之容器#{{HealingRed}} 治疗1红心#所有红心治疗量翻倍"},
	...
	[319] = {"319", "该隐的另一只眼", "向随机方向发射与角色相同效果的泪弹#{{Damage}} 造成75%角色伤害"}, -- Cain's Other Eye
	[320] = {"320", "???唯一的朋友", "可控制的苍蝇#造成每秒15点接触伤害"}, -- ???'s Only Friend
	[322] = {"322", "蒙戈宝宝", "复制其他跟班的泪弹效果#若没有跟班, 则发射普通的3.5伤害泪弹"},
	...
	[352] = {"352", "玻璃大炮", "{{Damage}} 发射1颗巨大的穿刺灵体泪弹, 造成10x角色伤害+10点伤害#{{Warning}} 持有时受伤:#↓ 额外受到2心伤害#↓ 大炮破碎持续数个房间#↑ {{Range}} 在当前房间中射程+1.5, 并留下血迹#额外伤害不会击杀以撒#自伤不会触发该效果"}, -- Glass Canon
	[353] = {"353", "炸弹人", "{{Bomb}} +5炸弹#炸弹十字爆炸#↓ 角色放置的炸弹伤害x0.75"},
	...
	[360] = {"360", "淫魔", "发射泪弹, 效果和属性与角色一致#{{Damage}} 造成75%角色伤害"}, -- Incubus
	...
	[368] =	{"368", "溢泪症", "↑ {{Tears}} 持续向单方向发射会逐渐提高射速修正至200%并降低射击精度"}, -- Epiphora
	[369] = {"369", "连续统", "↑ {{Range}} 射程+3#灵体泪弹#泪弹可以飞出屏幕一侧, 并从另一侧回来"}, -- Continuum
	...
	[375] = {"375", "寄居骷髅帽", "免疫爆炸和掉落弹幕#20%概率反弹敌人弹幕"}, -- Host hat
	[376] = {"376", "补货", "商店物品购买后会立刻补货#每次补货价格都会提高"}, -- Restock
	[380] = {"380", "充钱游戏", "{{Coin}} +5硬币#{{Coin}} 钥匙方块, 门和箱子必须用硬币打开而不是钥匙"}, -- Pay To Play
	[382] = {"382", "友好球", "可以扔向敌人将其捕捉#{{Friendly}} 成功捕捉后，下一次使用则会生成相同的友好敌人#靠近捕捉后的球会立即将道具充能"}, -- Friendly Ball
	[386] = {"386", "十二面骰", "将障碍物重置为其他随机类型的障碍物(大便/罐子/TNT/红大便/石头等)#小概率重置为按钮/击杀按钮/暗门/活板门"}, -- D12
	[384] = {"384", "肉山宝宝", "{{Chargeable}} 弹出并在房间中反弹, 速度基于蓄力时间#根据其速度, 每次击中造成5-20点接触伤害"}, -- Lil Gurdy
	...
	[395] = {"395", "科技X", "{{Chargeable}} 角色的泪弹由可蓄力的激光环取代#激光环尺寸和伤害随蓄力时间增加, 最多增加至100%角色伤害"}, -- Tech X
	[397] = {"397", "牵引光束", "↑ {{Tears}} 射速修正+1#↑ {{Range}} 射程+2.5#↑ {{Shotspeed}} 弹速+0.16#角色的泪弹受角色面前的光束指引"}, -- Tractor Beam
	[399] = {"399", "虚空之喉", "{{Chargeable}} 持续发射泪弹2.35秒后, 松开发射键会产生黑硫磺火圈#黑圈在2秒内造成30x角色伤害"}, -- Maw of the Void
	[401] = {"401", "爆炸物", "25%概率发射粘性泪弹#粘住的泪弹会变大并在几秒后爆炸, 造成1x角色伤害+60的伤害"}, -- Explosivo
	...
	[407] = {"407", "纯洁", "↑ 根据光环颜色对角色属性进行增强#受伤时, 移除光环, 在下个房间获得新的光环#{{ColorYellow}}黄色{{CR}} = ↑ {{Speed}} 移速+0.5#{{ColorBlue}}蓝色{{CR}} = ↑ {{Tears}} 射速修正+2#{{ColorRed}}红色{{CR}} = ↑ {{Damage}} 伤害+4#{{ColorOrange}}橙色{{CR}} = ↑ {{Range}} 射程+3"},
	[408] = {"408", "祭祀之刃", "25%概率在被击杀敌人周围生成黑色硫磺火圈#黑圈2秒内造成30x角色伤害#{{Luck}} 每点幸运+2.5%概率"}, -- Athame
	...
	[419] = {"419", "传送2.0", "传送至未探索的随机房间#等级: {{Room}}>{{BossRoom}}>{{SuperSecretRoom}}>{{Shop}}>{{TreasureRoom}}>{{Planetarium}}>{{SacrificeRoom}}{{DiceRoom}}>{{Library}}>{{CursedRoom}} >{{MiniBoss}}>{{ChallengeRoom}}{{BossRushRoom}}>{{ArcadeRoom}}{{ChestRoom}}>{{IsaacsRoom}}{{BarrenRoom}}>{{SecretRoom}}>{{DevilRoom}}{{AngelRoom}}>{{ErrorRoom}}"},
	...
	[432] = {"432", "闪光炸弹", "{{Bomb}} +5炸弹#角色的炸弹爆炸时, 63%概率生成1随机掉落物, 15%概率魅惑炸到的敌人#当前楼层每次生成掉落物后, 生成概率降低1%"}, -- Glitter Bombs
	...
	[442] = {"442", "黑王子之冠", "红心为1时:#↑ {{Tears}} 射速修正+2#↑ {{Range}} 射程+1.5#↑ {{Shotspeed}} 弹速+0.2"}, -- Dark Princes Crown
	...
	[450] = {"450", "贪婪的眼睛", "{{Damage}} 每发射20颗泪弹, 发射1颗硬币泪弹, 造成1.5x角色伤害+10的伤害#{{Petrify}} 被硬币泪弹击中的敌人石化并变为金块#{{Coin}} 击杀金敌人掉落1-3硬币#{{Warning}} 发射硬币泪弹消耗1硬币"}, -- Eye of Greed
	[451] = {"451", "塔罗牌桌布", "{{Card}} 生成1卡牌#{{Card}} 部分塔罗牌效果翻倍或增强"}, -- Tarot Cloth
	...
	[489] = {"489", "无限面骰", "可以通过掉落键({{ButtonRT}})更改为任意骰子道具({{Collectible723}}计数二十面骰除外)#充能条基于最后使用的骰子变化"}, -- D Infinity
	[491] = {"491", "毒瘾宝宝", "{{Pill}} 每7个房间生成1随机胶囊#{{Poison}} 使用胶囊会使房间中所有敌人中毒"}, -- Acid Baby
	[493] = {"493", "肾上腺素", "↑ {{Damage}} 空心之容器能提高伤害#空心之容器越多, 每个新的空心之容器的伤害加成越高"}, -- Adrenaline
	...
	[525] = {"525", "麻风病", "受伤时, 生成1个阻挡弹幕的环绕物#最多有3个环绕物#每秒造成30点接触伤害#环绕物受伤过多后被摧毁"},
	[531] = {"531", "泪血症", "↑ {{Damage}} 伤害+1#↑ {{Damage}} 伤害修正x1.5#↓ {{Tears}} 射速修正x0.33#↓ {{Range}} 射程修正x0.8#角色的泪弹呈抛物线前进, 击中时分裂成更小的泪弹"}, -- Haemolacria
	[532] = {"532", "食泪症", "角色的泪弹前进时减速, 停止后会爆裂成5-8颗小泪弹#泪弹可以合并变大"},
	[543] = {"543", "圣地大便", "受伤时, 生成白大便#在大便光环中时:#↑ {{Tears}} 射速修正x2.5#↑ {{Damage}} 伤害修正x1.2#追踪泪弹#50%概率阻挡伤害"}, -- Hallowed Ground
	[549] =	{"549", "脆骨症", "{{EmptyBoneHeart}} 角色所有的心之容器由6空骨心取代#失去骨心时:#↑ {{Tears}} 射速修正+0.4#向四周方向发射10颗骨头泪弹"}, -- Brittle Bones
	...
	[558] = {"558", "眼瘤", "概率向随机方向发射1-3颗额外泪弹#{{Luck}} 不受幸运影响"}, --  Eye Sore
	[559] = {"559", "220伏", "反复电击附近敌人#{{Damage}} 电击每秒造成3.75x角色伤害#电弧可电穿最多4个其他敌人"}, --  120 Volt
	[560] = {"560", "好疼", "{{Timer}} 受伤时, 在当前房间中获得:#↑ {{Tears}} 首次受伤射速修正+1.2#↑ {{Tears}} 后续受伤射速修正+0.4#在角色周围释放10颗泪弹"}, --  It Hurts
	...
	[567] = {"567", "逾越节蜡烛", "↑ {{Tears}} 若清理房间且不受伤害, 则射速修正+0.4#最多+2{{ColorSilver}}(5个房间){{CR}}"}, --  Paschal Candle
	...
	[571] = {"571", "孤儿的袜子", "↑ {{Speed}} 移速+0.3#{{SoulHeart}} +2魂心#免疫水迹和地刺"}, --  Orphan Socks
	...
	[575] = {"575", "侵体蜘蛛", "{{Slow}} 蜘蛛埋在角色头里, 额外发射4颗减速泪弹, 造成1.5点伤害#受伤时, 蜘蛛有25%概率离开头并追击敌人"}, --  The Intruder
	[576] = {"576", "龌龊之心", "所有粪滴敌人变得友好#摧毁大便时, 生成1-4个粪滴#粪滴类型取决于大便类型#石头有6.25%概率会由大便取代"}, --  Dirty Mind
	...
	[581] = {"581", "灵能苍蝇", "追击并阻挡敌人弹幕#每秒造成15点接触伤害"}, --  Psy Fly
	[582] = {"582", "迷幻蘑菇", "↑ {{Tears}} 射速修正+0.75#↓ {{Speed}} 移速-0.03#扭曲画面#每次使用后延长充能时间#离开或清理房间可减弱效果"}, --  Wavy Cap
	...
	[589] = {"589", "月亮", "每层额外增加1个{{SecretRoom}}隐藏房和{{SuperSecretRoom}}超级隐藏房#每层揭示1个隐藏房#{{Timer}} 隐藏房内有光束, 接触时在本层获得:#↑ {{Tears}} 射速修正+0.5#↑ {{Tears}} 每层首个光柱额外+0.5射速修正#{{HalfSoulHeart}} 1半魂心"}, --  Luna
	...
	[612] = {"612", "迷失游魂", "受伤时死亡, 会在下一层重生#如果存活时带到下一层, 可能生成:#{{SoulHeart}} 3魂心#{{EternalHeart}} 2永恒之心#{{TreasureRoom}} 1个宝箱房道具#{{AngelRoom}} 1个天使房道具"}, --  Lost Soul
	[613] = {"613", "", "<道具不存在>"},
	[614] = {"614", "鲜血炸弹", "↑ {{Heart}} +1心之容器#{{HealingRed}} 治疗4红心#{{HalfHeart}} 若角色没有炸弹, 则可以花费半心放置炸弹#角色的炸弹会留下血迹"}, --  Blood Bombs
	[615] = {"615", "屁球宝宝", "角色即将受伤时, 弹开敌人或弹幕#弹开后需要触碰才能再次激活"}, --  Lil Dumpy
	[616] = {"616", "鸟眼椒", "8%概率发射红火, 阻挡敌人弹幕并造成接触伤害#{{Luck}} 幸运10: 50%概率#火焰造成或阻挡4次伤害后或10秒后消失"}, --  Bird's Eye
	...
	[644] = {"644", "安慰奖", "↑ 提升角色移速/射速/伤害/射程中最低的属性#根据角色持有的最少掉落物, 生成3{{Coin}}硬币/1{{Bomb}}炸弹/1{{Key}}钥匙"}, --  Consolation Prize
	...
	[657] = {"657", "血管炎", "敌人死亡时爆出泪弹, 继承死亡时带有的效果"}, --  Vasculitis
	...
	[664] = {"664", "大胃王", "↑ {{Heart}} +1心之容器#{{HealingRed}} 回满血#所有底座道具会周期性地切换为食物道具#拾起食物道具时获得:#{{HealingRed}} 额外治疗1红心#↑ {{Damage}} 暂时伤害+3.6#↑ 永久提升2项属性(取决于食物)#↓ {{Speed}} 移速-0.03"}, --  Binge Eater
	...
	[677] = {"677", "灵魂出窍", "{{Timer}} 在有敌人的房间中首次受伤时, 获得:#灵体泪弹#飞行#抵消下次伤害#时间暂停2秒#2秒内大幅提升移速和射速"}, --  Astral Projection
	...
	[680] = {"680", "水土不服症", "{{Chargeable}} 蓄力并从角色后方发射短程高伤害光柱#不取代角色泪弹"}, --  Montezuma's Revenge
	...
	[695] = {"695", "嗜血腥风", "受伤时, 在本层获得:#↑ {{Speed}} 移速提升#↑ {{Tears}} 射速提升#最多移速+1.02, 射速修正+3"}, --  Bloody Gust
	...
	[698] = {"698", "作孽双子", "发射与角色相同属性和效果泪弹的2个跟班#{{Damage}} 每个跟班造成37.5%角色伤害"}, --  Twisted Pair
	...
	[704] = {"704", "狂怒！", "{{Battery}} 造成伤害时充能#{{Timer}} 5秒内获得:#↑ {{Speed}} 移速+0.4#↓ {{Tears}} 射速修正x0.5#↑ {{Tears}} 射速修正+2#↑ {{Damage}} 伤害+3#只能使用特定近战武器, 能反弹弹幕#{{Timer}} 击杀敌人可延长此状态1秒, 并获得短暂无敌"}, --  Berserk!
	...
	[712] = {"712", "所罗门魔典", "生成1个环绕物, 获得随机道具的效果#该道具有25%概率来自当前房间的道具池, 75%概率来自随机道具池"}, --  Lemegeton
	...
	[716] = {"716", "店主的胯袋", "拾起时, 生成3{{Coin}}硬币和1{{Key}}钥匙#{{Shop}} 每花费3硬币获得其一:#↑ {{Speed}} 移速+0.03#↑ {{Damage}} 伤害+0.5#↑ {{Range}} 射程+0.25"}, --  Keeper's Sack
	...
	[728] = {"728", "格罗", "在当前房间中, 角色会迸出恶魔跟班#恶魔向最近的敌人发射, 模仿角色属性和泪弹效果#{{Damage}} 其泪弹造成75%角色伤害"}, --  Gello
...
EID.descriptions[languageCode].bingeEaterBuffs = {
	...
	[26] = "↑ {{Damage}} 伤害+1#↑ {{Range}} 射程+2.5#↑ {{Damage}} 暂时伤害+3.6#↓ {{Speed}} 移速-0.03", -- Rotten Meat
...
EID.descriptions[languageCode].bookOfBelialBuffs = {
	...
	[635] = "在角色和织布魔偶之间产生{{Collectible705}}暗仪刺刀的效果", -- Stitches
	...
	[729] = "当头分离时:#↑ {{Tears}} 射速修正x3#↑ {{Damage}} 伤害+2", -- Decap Attack
}
...
EID.descriptions[languageCode].BookOfVirtuesWispTexts = {
	...
	Damage = "{1}%伤害", 					-- {1} will be replaced with the damage changes in %
...
local repTrinkets={
	...
	[11] = {"11", "环形虫", "↑ {{Tears}} 射速+0.4#灵体泪弹#角色的泪弹高速螺旋前进"}, -- Ring Worm
	...
	[32] = {"32", "裸盖蘑菇", "每个房间25%概率获得随机蘑菇效果"}, -- Liberty Cap
	[33] = {"33", "脐带", "{{HalfHeart}} 不多于半红心时, 获得{{Collectible100}}史蒂文宝宝#{{Collectible318}} 受伤时高概率在当前房间中生成双子座跟班"}, -- Umbilical Cord
	[39] = {"39", "癌症", "↑ {{Tears}} 射速修正+1"}, -- Cancer
	...
	[66] = {"66", "懒懒虫", "↓ {{Shotspeed}} 弹速-0.5"}, -- Lazy Worm
	...
	[152] = {"152", "望远镜片", "{{PlanetariumChance}} 星象房基础概率+9%#{{PlanetariumChance}} 第一次进入星象房前, 概率额外+15%#星象房会出现在子宫和尸宫中"}, --  Telescope Lens
	...
	[176] = {"176", "小血团", "生成1个血块跟班, 模仿角色的行动#复制角色的属性和泪弹效果, 造成35%角色伤害#每个房间重生"}, --  Lil Clot
	...
	[180] = {"180", "复得游魂", "精确跟随角色移动, 发射灵体泪弹#复制角色的属性和泪弹效果, 造成50%角色伤害#使用角色使用的大多数主动道具#复得游魂受伤即死#每层重生"}, --  Found Soul
	...
	[184] = {"184", "领养协议书", "{{Shop}} 商店的道具由跟班取代, 售价10硬币"}, --  Adoption Papers
...
EID.descriptions[languageCode].goldenTrinketEffects = {
	...
	[4] = { "{{Collectible419}} 使用主动道具时, 将角色传送至{{ColorGold}}未探索的随机房间{{CR}}#顺序: {{Room}}>{{BossRoom}}>{{SuperSecretRoom}}>{{Shop}}>{{TreasureRoom}}>{{Planetarium}}>{{SacrificeRoom}}{{DiceRoom}}>{{Library}}>{{CursedRoom}} >{{MiniBoss}}>{{ChallengeRoom}}{{BossRushRoom}}>{{ArcadeRoom}}{{ChestRoom}}>{{IsaacsRoom}}{{BarrenRoom}}>{{SecretRoom}}>{{DevilRoom}}{{AngelRoom}}>{{ErrorRoom}}"}, -- Teleport 2.0
...
local repCards={
	...
	[56] = {"56", "0-愚者？", "将角色的所有心(留半心)和掉落物掉在地上#若数量充足, 可作为{{Collectible74}}25美分和{{Collectible19}}轰! 等道具生成"}, -- 0 - The Fool?
	[57] = {"57", "I-魔术师？", "{{Timer}} 获得排斥敌人和弹幕的光环, 持续60秒"}, -- I - The Magician?
	[58] = {"58", "II-女祭司？", "{{Timer}} 妈腿持续尝试践踏角色, 持续60秒"}, -- II - The High Priestess?
	[59] = {"59", "III-皇后？", "{{Timer}} 在60秒内获得:#↑ {{Heart}} +2心之容器#↑ {{Tears}} 射速修正+1.5#↓ {{Speed}} 移速-0.1"}, -- III - The Empress?
	[60] = {"60", "IV-皇帝？", "传送至额外头目房, 清理后可获得道具#生成的头目来自下一章节"}, -- IV - The Emperor?
	[61] = {"61", "V-教皇？", "{{EmptyBoneHeart}} 生成2骨心"}, -- V - The Hierophant?
	[62] = {"62", "VI-恋人？", "生成当前房间道具池的1个道具#{{BrokenHeart}} 将1心之容器或2魂心转换为1碎心"}, -- VI - The Lovers?
	...
	[85] = {"85", "???的魂石", "{{Poison}} 产生8团毒气并留下棕色水迹, 然后快速生成7屁股炸弹#站在水迹中获得:#↑ {{Tears}} 射速修正+1.5#↑ {{Damage}} 伤害+1"}, -- Soul of ???
...
EID.descriptions[languageCode].horsepills={
	...
	{"32", "变大胶囊", "角色体型大幅变大#不影响碰撞箱"}, -- One makes you larger
	{"33", "变小胶囊", "角色体型大幅变小#影响碰撞箱"}, -- One makes you small
	...
	{"44", "呕！", "{{Collectible149}} 发射1串吐根酊泪弹"}, -- Horf!
...
local repCharacterInfo = {
	...
	[10] = {"游魂", "飞行#灵体泪弹#{{Warning}} 没有血量#{{DevilRoom}} 每个房间可以免费进行1次恶魔交易"},
	[11] = {"复活的拉撒路", "提升属性, 伤害修正x1.4#进入新层时会变回拉撒路"},
	[12] = {"犹大之影", "{{Damage}} 伤害修正x2#无法拥有红心#{{BlackHeart}} 体力上升改为获得黑心#{{Player3}} 通关标记记为犹大的"},
	...
	[22] = {"堕化抹大拉", "超过2红心的血量会缓慢流失#接触敌人时进行一次近战攻击, 造成6x角色伤害#{{HalfHeart}} 敌人有概率掉落2秒后消失的半红心#近战击杀时必定掉落半红心#{{Collectible45}} 通过非拾取途径获得的治疗效果翻倍#{{AngelDevilChance}} 会流失的红心不影响恶魔房概率"},
	...
	[27] = {"堕化参孙", "造成或受到伤害会为积攒狂暴状态#{{Timer}} 进入狂暴状态时, 在5秒内:#↑ {{Speed}} 移速+0.4# {{Tears}} 射速修正x0.5#↑ {{Tears}} 射速修正+2#↑ {{Damage}} 伤害+3#攻击变为能反弹子弹的近战攻击#{{Timer}} 每次击杀增加1秒狂暴持续时间并获得短暂无敌"},
...
EID.descriptions[languageCode].birthright ={
	...
	{"该隐", "", "↑ {{Luck}} 幸运+1#{{ArcadeRoom}} 后续所有层都含有一个升级的赌博房(暗室, 玩具箱除外)#{{Collectible46}} 极大增强幸运脚的获胜概率提高的效果"},
	...
	{"犹大之影", "", "{{Collectible34}} 彼列之书变成类似于{{Collectible584}}美德之书的被动道具#{{Collectible34}} 若当前未持有则获得彼列之书#↑ {{Damage}} 获得的伤害加成与在其上的主动道具充能量成比例#某些主动道具会获得特殊效果"},
	{"莉莉丝", "", "跟班列于莉莉丝面前"},
	{"店主", "", "↑ {{CoinHeart}} +1硬币心容器#硬币心容器上限提高为4"},
...
EID.descriptions[languageCode].itemPoolNames = {
	[0] = "宝箱房", "商店", "头目房", "恶魔房", "天使房", "隐藏房", "图书馆", "赌博乞丐", "金箱子", "红箱子", "乞丐", "恶魔乞丐", "诅咒房", "钥匙大师", "电池乞丐", "妈妈的箱子", "贪婪宝箱房", "贪婪头目房", "贪婪商店", "贪婪恶魔房", "贪婪天使房", "贪婪诅咒房", "贪婪隐藏房", "夹娃娃机", "究极隐藏房", "炸弹乞丐", "星象房", "旧箱子", "宝宝商店", "木箱子", "腐烂乞丐",
}

EID.descriptions[languageCode].VoidShopText = "若在举起道具时吸收, 则获得:"
EID.descriptions[languageCode].VoidOptionText = "将被吸收"
EID.descriptions[languageCode].VoidNames[2] = "射速修正{1}"
...
local repConditions = {
	...
	["5.100.549"] = {"↑ {{Tears}} 射速修正+0.4"}, -- Brittle Bones (Keeper+Lost)
	...
	["5.100.224 (Copies)"] = "额外重复品仅有射速修正+0.5的效果", -- Cricket's Body
	...
	["Binge Eater Healing"] = {"治疗 1 红心", "治疗 {{BlinkGreen}}2{{CR}} 红心", "+4红心充能", "+{{BlinkGreen}}6{{CR}}红心充能"},
}
